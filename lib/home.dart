...
//import 'package:flutter_project_gorouter_test/logout.dart';
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8.0),
                  ElevatedButton(
                    child: const Text('Go to Simulation'),
                    onPressed: () {
                      context.go('/simulation_rentabilite');
                    },
                  ),
                  const SizedBox(height: 8.0),
                  ElevatedButton(
                    child: const Text('Go to Taxe de bienvenue'),
                    onPressed: () {
                      context.go('/taxe_bienvenue');
                    },
                  ),
                ],
              ),
